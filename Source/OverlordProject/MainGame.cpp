...
#include "Scenes/Exam/PauseMenuScene.h"
#include "Scenes/Exam/MainMenuScene.h"
#include "Scenes/Exam/WonMenuScene.h"
#endif
...
void MainGame::OnGamePreparing(GameContext& gameContext)
{
	...
	gameContext.windowTitle = L"GP2 - Exam Project (2022) | (2DAE06) Vanden Heede Pauline";
}
...
void MainGame::Initialize()
{
	...
	SceneManager::Get()->AddGameScene(new WonMenuScene{});
